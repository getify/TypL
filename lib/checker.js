...
var MSG = {
	...
	ERR_BINARY_PLUS_MIXED_TYPES: 118,
	ERR_RELATIVE_OP_MIXED_TYPES: 119,
	ERR_RELATIVE_OP_BOTH_TYPES: 120,
	ERR_RELATIVE_OP_TYPE: 121,
	ERR_LOOSE_EQUALITY_UNKNOWN_TYPE: 122,
	ERR_LOOSE_EQUALITY_MIXED_TYPES: 123,
	ERR_STRICT_EQUALITY_KNOWN_MIXED_TYPES: 124,
	ERR_STRICT_EQUALITY_KNOWN_MATCHING_TYPES: 125,
	ERR_UNARY_NUMERIC_OP_TYPE: 126,
	ERR_MODULUS_OP_BOTH_TYPES: 127,
	ERR_MODULUS_OP_TYPE: 128,
	ERR_BINARY_NUMERIC_OP_TYPE: 129,
	ERR_FUNC_RETURN_TYPE: 130,
	ERR_FUNC_RETURN_SIGNATURE: 131,
	ERR_TERNARY_COND_TYPE: 132,
	ERR_SPREAD_UNKNOWN_TYPE: 133,
	ERR_SPREAD_TYPE: 134,
...
var collectTypesVisitors = {
			...
			if (funcSignature) {
				...
				if (!(
					...
					if (path.node.argument) {
						...
						returnType = { inferred: "undef", explicit: true, };
						markedKnowns.add(funcSignature.return);
					}
	...
	Identifier(path) {
		...
		// any other identifier?
			...
			// NOTE: no type (yet), not `undefined`, either param or
			// non-local binding, so flag as 'unknown'
			else if (
